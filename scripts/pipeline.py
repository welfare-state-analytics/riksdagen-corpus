...
def main(args):
    ...
    if False:
        ...
        segmentation_db = segmentation_workflow(
            file_db, archive, segmentation_patterns, mp_db, ml=False
        )
    ...
    if True:
        parlaclarin_workflow_individual(
            file_db, archive, curations=curation_db, segmentations=segmentation_db
        )
